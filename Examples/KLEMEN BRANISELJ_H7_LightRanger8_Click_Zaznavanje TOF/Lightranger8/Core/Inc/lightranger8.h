...
#ifndef INC_LIGHTRANGER8_H_
#define INC_LIGHTRANGER8_H_





#endif /* INC_LIGHTRANGER8_H_ */
...
// Define the power control register and the value to power on
...
// Driver delays
void delay_power_full_on ( lightranger8_t *ctx );
void delay_power_up ( lightranger8_t *ctx );
void delay_config_set ( lightranger8_t *ctx );
void delay_soft_reset ( lightranger8_t *ctx );
void delay_data_ready ( lightranger8_t *ctx );

// Writing 8-bit data to a register
