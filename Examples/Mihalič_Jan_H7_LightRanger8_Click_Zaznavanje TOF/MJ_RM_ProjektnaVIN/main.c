...
/* USER CODE BEGIN PV */
	...
	// Write this value into LIGHTRANGER8_SYSTEM_MODE_START register to enable ranging mode.
...
int main(void)
{
	...
	// Now the sensor is ready for communication
  	...
  	// Check that the model ID of the sensor matches
  	checkModelID();
  	HAL_Delay(100);
